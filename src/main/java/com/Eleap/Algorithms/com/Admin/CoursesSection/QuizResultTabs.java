...
public class QuizResultTabs extends BaseTab {
    ...
    public void clickScormResultTab() {
        scormResult.click();

    }

    public void clickGradingCenterSection() {
        gradingCenter.click();
    ...
    public void fillAddQuestion(CharSequence param) {
        addQuestion.sendKeys(param);

    }

    public void fillFeedback(CharSequence param) {
        feedbackSend.sendKeys(param);

    }

    public void fillAnswerQuestion(CharSequence param) {
    ...
    public void clickCoursesSection() {
        coursesSection.click();

    }

    public void clickChooseOptionQuestion() {
    ...
    public void fillFeedbackText(CharSequence param) {
