...
public class CoursesSectionAdminPage extends BasePage {
    ...
    @FindBy(xpath = "//div[1]/div[1]/div[1]/ul/li[10]/a")
    ...
    public void fillUserOrEmailField(CharSequence param) {
    ...
    public void clickDeleteDeleteCourse() {
        waitForElementToBeClickable(driver, deleteCourse, 10);
        deleteCourse.click();
    }
    ...
    public CoursesSectionAdminPage assignUser() throws InterruptedException {
